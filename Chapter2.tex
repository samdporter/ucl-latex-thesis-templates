...
\begin{comment}
Although this is not emphasised explicitly in \cite{ehrhardtFastPETReconstruction2025}, the harmonic averaging viewpoint can also be interpreted as a majorisation-preserving way to combine curvature information from the likelihood and the prior. In particular, the voxel-wise harmonic blend can be rearranged as
\begin{equation}
