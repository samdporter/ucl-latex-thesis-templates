...
\end{equation}
where $I$ is the $d\times d$ (number of dimensions, $d$, squared) identity matrix and $\gamma_j\in[0,1]$ controls the strength of directional guidance. The resulting \gls{dtv} prior is
