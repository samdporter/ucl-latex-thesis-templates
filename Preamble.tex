...
We also develop a Monte Carlo-informed Bremsstrahlung SPECT model comprising a damped, pre-reconstruction estimate of non-primary contamination and an effective image-space response kernel.
...
\glsaddall[types={symbols}] % force every notation entry into the printed list
\printglossary[type=\acronymtype,title={List of Abbreviations},nonumberlist]
\printglossary[type=symbols,title={Notation},nonumberlist]
