...
\begin{figure}[htbp]
    ...
    \caption{Final \gls{pet} and \gls{spect} iterates of the long-run reference reconstruction, shown on a matched slice with independent colour bars. This pair is the reference $x^\star$ against which the \gls{nrmse} curves of Chapter~\ref{chapter:optimisation} are measured; it is the long-run baseline rather than one of the candidate preconditioner settings compared there.}
