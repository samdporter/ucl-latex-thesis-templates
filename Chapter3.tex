...
An even more geometric framework is \gls{pls} \cite{ehrhardt_vector-valued_2014}. These methods encourage structural consistency by encouraging the gradient vectors of the emission image and the guidance image to be aligned, i.e.\ $D x_j \parallel D u_j$. A common formulation (often termed \gls{pls}1) penalises the magnitude of the component of $D x_j$ orthogonal to $D u_j$, which is proportional to the sine of the enclosed angle $\theta_j$:
\begin{equation}
    R_{\mathrm{PLS1}}(x,u)
